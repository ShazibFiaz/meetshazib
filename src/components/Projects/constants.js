...
import chatMobileVid from "../../Assets/Projects/chitChatMobileVid.mp4";
...
import chitChatGp from '../../Assets/Projects/createGroupChat.png'
import chatConnect from '../../Assets/Projects/chatConnect.png'
const projectData = {
...
`,
miniDesc:   `Chirp is a minimalist Twitter clone focused on speed, simplicity, and real-time interaction. Users can sign up, log in, and share short text-based updates in a clean, distraction-free UI.`,
...
,
  ...
  chitchat: {
    ...
    `,
    miniDesc:`Made with ReactJS, Express, NodeJs, MongoDB and Socket.io, ChitChat makes staying connected easy with real-time messaging, group chats, and typing indicators that keep conversations flowing naturally—just like talking in person.`,
    features: [
